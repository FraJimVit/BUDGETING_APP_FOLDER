...
import { PerfilComponent } from './perfil/perfil.component'; // Importa tu componente de perfil
...
export class AppComponent implements OnInit {
  ...
  currentPage: string = 'home'; // Variable para controlar la página actual
  ...
  constructor(
    private service: GenericService<Product>,
